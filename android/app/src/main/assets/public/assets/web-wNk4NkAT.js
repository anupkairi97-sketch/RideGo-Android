import{_ as Ut,g as Dt,a as Ln,b as Un,c as m,d as y,e as $e,i as Ke,p as Dn,q as Y,f as te,h as ne,F as ze,E as Je,j as Mn,k as Vn,l as Wn,L as Fn,m as Mt,S as de,n as v,o as Hn,r as xn,D as Gn,s as $n,t as jn,u as ct,C as lt,v as ut,w as qn,W as Bn,P as q,x as ge}from"./index-BCbHuk6N.js";function Vt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Kn=Vt,Wt=new Je("auth","Firebase",Vt());/**
 * @license
